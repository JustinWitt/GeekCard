...
public class RegularUse extends Activity{
    PopupWindow pw;
    PopupWindow pw2;
    PopupWindow newpw;
    ...
    public static final String USERNGUPDATE = "http://www.boffinapes.com/gcstuff/nginfoupdate.php";
    public static final String SYNCFROMEDB = "http://www.boffinapes.com/gcstuff/synccontacts.php";
    public static final String DELCARDLINK = "http://www.boffinapes.com/gcstuff/deletecontact.php";
    public static final String FORGOTPASSLINK = "http://www.boffinapes.com/gcstuff/forgotpass.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(sharedPref.contains("userID")){
            ...
            //pass to sorry, no sombrero page
            /*
        ...
        if(cur.getCount() < 1){
            ...
            startActivity(passer);
            */
            //go to edit screen automatically
            //**** DOING IN A BIT****
            //nametxt = "DOING FINE";
        }
        else{
        ...
        File imgFile = new  File(RegularUse.this.getFilesDir(), userID + ".png");//wherever that is
        if(imgFile.exists()){
        ...
        ngdivide.setTextColor(Color.WHITE);
        ...
        nerd1.setTextColor(Color.WHITE);
        nerd1.setText(nerdstuff);
        nlvls.setTextColor(Color.WHITE);
        nlvls.setText(nerdlvls);
        geek1.setTextColor(Color.WHITE);
        geek1.setText(geekstuff);
        glvls.setTextColor(Color.WHITE);
        glvls.setText(geeklvls);
        
        
        tophalf.isClickable();
        tophalf.setOnClickListener(new OnClickListener(){
            public void onClick(View v) {
                Intent passer = new Intent(RegularUse.this, TopEdit.class);
                startActivity(passer);
                finish();
            }
        });
    
        bottomhalf.isClickable();
        bottomhalf.setOnClickListener(new OnClickListener(){
            public void onClick(View v) {
                //Intent passer = new Intent(RegularUse.this, NGEdit.class);
                Intent passer = new Intent(RegularUse.this, TestActivity.class);
                startActivity(passer);
                //finish();
            }
        });
        ...
        LinearLayout contactedit = (LinearLayout) findViewById(R.id.contactedit);
        contactedit.isClickable();
        contactedit.setOnClickListener(new OnClickListener(){
            public void onClick(View v) {                
                Intent passer = new Intent(RegularUse.this, ContactEdit.class);
                startActivity(passer);     
            }
        });
    ...
    public void addopencontacts(){
        ...
        opencbut.setOnClickListener(new OnClickListener(){
            public void onClick(View v){
                pw.dismiss();
                Intent passer = new Intent(RegularUse.this, ContactDisplay.class);
                startActivity(passer);
            }
        });
        Button showcode;
    ...
    class AddUserCard extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(RegularUse.this);
        ...
        protected String doInBackground(String... args) {
            ...
            // getting JSON Object
            JSONObject json = jsonParser.makeHttpRequest(RegularUse.ADDCARDLINK,"POST", params);
...
/***********************ESSENTIAL DB STUFF***********************/
    ...
    public void saveBitmapFromURL(int userID) {
        ...
        try {
            ...
            try {
                File imgFile = new File(RegularUse.this.getFilesDir(), userID + ".png");
